...
<p><small> An overview showcasing various data modalities obtained from different spatial transcriptomics technologies (Images adapted from [@MERFISHSpatialProfiling], [@SpatialGeneExpression]). </small></p>
