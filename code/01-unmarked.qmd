...
#transform the distances to sqrt
nndistances_k5_ependymal <- sqrt(nndistances_k5_ependymal)#/median(nndistances_k5_ependymal)
nndistances_k5_odmature <- sqrt(nndistances_k5_odmature)#/median(nndistances_k5_odmature)
nndistances_k5_microglia <- sqrt(nndistances_k5_microglia)#/median(nndistances_k5_microglia)

#create a histogram of the nearest-neighbour distances
hist_ependymal <- hist(nndistances_k5_ependymal, breaks = 25, plot = FALSE)
hist_odmature <- hist(nndistances_k5_odmature, breaks = 25, plot = FALSE)
hist_microglia <- hist(nndistances_k5_microglia, breaks = 25, plot = FALSE)
...
plot(hist_ependymal, col = c1, main = "Histogram of nn-distances with Gamma Mixtures fitted",ylim=c(0,1), freq=FALSE, xlab='Nearest neighbour distances k=5')
legend(15,0.8, legend=c("Ependymal", "OD Mature", "Microglia"),col=c('blue', 'red', 'green'), lty=1, cex=0.8)
...
#scale by the median nearest-neighbour distance or the window size
nndistances_k5_pp1 <- sqrt(nndistances_k5_pp1)/(median(sqrt(nndistances_k5_pp1)))#/diff(range(w1))#/(median(sqrt(nndistances_k5_pp1)))
nndistances_k5_pp2 <- sqrt(nndistances_k5_pp2)/(median(sqrt(nndistances_k5_pp2)))#/diff(range(w2))#/(median(sqrt(nndistances_k5_pp2)))
...
plot(hist_pp1, col=c1, main = "Histogram of k=5 nn-distances with Gamma Mixtures fitted",freq=FALSE, ylim=c(0,3), xlab = "nn-distance")
