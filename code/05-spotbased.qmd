...
localplot(sfe_tissue, 'nCounts', fun = 'localmoran', plotvar = 'locEffect')
localplot(sfe_tissue, 'nGenes', fun = 'localmoran', plotvar = 'locEffect')
```
...
--> add formula and explanaition etc.

```{r}
localplot(sfe_tissue, var = 'nCounts', fun = 'localC_perm', plotvar = 'locEffect')
localplot(sfe_tissue, var = 'nGenes', fun = 'localC_perm', plotvar = 'locEffect')
```
...
```{r}
localplot(sfe_tissue, var = 'nCounts', fun = 'localG', plotvar = 'locEffect')
localplot(sfe_tissue, var = 'nGenes', fun = 'localG', plotvar = 'locEffect')
```
...
```{r}
localplot(sfe_tissue, var = 'nCounts', fun = 'LOSH', plotvar = 'locEffect')
localplot(sfe_tissue, var = 'nGenes', fun = 'LOSH', plotvar = 'locEffect')
```

## Measures for Bi- and Multivariate Data
