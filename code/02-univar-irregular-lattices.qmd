...
spdep::moran.mc(x = logcounts(sfe)["KRT17",],
                ...
                nsim = 200)
```
We can see both genes have a positive Moran's I coefficient and a highly significant p-value. This indicates that these genes are spatially auto-correlated.
