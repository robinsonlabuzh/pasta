...
adata.obs.to_csv("../misc/test/test-00-overview-lat-Python.csv")
```
...
localResults(sfe)[[1]] |> as.data.frame() |> 
  write.csv("../misc/test/test-00-overview-lat-R.csv")
...
data.frame(test = c("Morans_I_calr", "Morans_I_myh2"), identical = test) |> 
  write.csv("../misc/test/test-00-overview-lat-R-Python-compare.csv")
```
